...
require_once(ROOT_PATH . '/library/T/Markdown/markdown_extended.php');
...
function get_options() {
	...
	// Load User Config
	$config_file = DOC_PATH . '/config.json';
...
function get_tree($path = '.', $clean_path = '', $title = ''){
	...
	foreach($paths as $file) {
        ...
        if(!in_array($file, $ignore)) {
            ...
            if(is_dir("$path/$file")) {
                if (preg_match('%doc\.php%i', $clean_path)) {
                    $url = $clean_path . '/' . $clean_sort;
                } else {
                    $url = $clean_path . '/doc.php?d=' . $clean_sort;
                }
            	// Directory
                ...
                if (preg_match('%doc\.php%i', $clean_path)) {
                    $url = $clean_path . '&f=' . $clean_sort;
                } else {
                    $url = $clean_path . '/doc.php?f=' . $clean_sort;
                }
